...
import io.dudesolutions.report.DudeReportApiClient;
import io.dudesolutions.report.testing.HttpCallBackCatcher;
...
public class ControllerTestBase {
    ...
    private static DudeReportApiClient client;
     ...
     * @return
     */
    protected static DudeReportApiClient getClient() {
        if(client == null)
            synchronized (clientSync) {
                client = new DudeReportApiClient();
            }
        return client;
    }
}
